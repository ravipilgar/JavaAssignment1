...
public class Program10 {
	...
	public static void main(String[] args) {
		...
		Trainer t1 = new Trainer("1", "Ravi", "java", 25000);
		Trainer t2 = new Trainer("2", "Mangesh", "python", 25000);
		Trainer t3 = new Trainer("3", "Surendra", "java", 19000);
		Trainer t4 = new Trainer("4", "Narendra", "MEAN", 25000);
		Trainer t5 = new Trainer("5", "Harshal", "java", 21000);
	}
